...
module.exports = (function () {
     ...
     *                  - a function that validate the value (check ve API to provide helper)
     */
    function ve(definition) {
        ...
        default:
            throw new Error("Unknown ve definition of type: '"+type+"'")
        }
    }
     ...
     */
    ve.and = function () {
        var v = Array.prototype.slice.call(arguments).map(ve)
        return function(e) {
            return v.every(function (f) { return f(e) }) 
        }
    }
